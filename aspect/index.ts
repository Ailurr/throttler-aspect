...
class Aspect implements IPreContractCallJP {
    ...
    preContractCall(input: PreContractCallInput): void {
        ...
        const interval = sys.aspect.property.get<u64>("inverval");
        ...
        const lastExecState = sys.aspect.mutableState.get<u64>(storagePrefix + 'lasteExecAt');
        let lastExec = lastExecState.unwrap();
        ...
        let execTimes = execTimeState.unwrap();
